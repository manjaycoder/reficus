...
const Stripes = () => {
  var data=[
    {url:'https://assets-global.website-files.com/6334198f239547d0f9cd84b3/63c9ce90a51cd7cf6b3689fb_css-design-awards-logos-id1L9L8Yvp%201.svg',number:42},
  ...
  return <>
   <div className="mb-20 mt-20 flex items-center justify">
    {data.map((elem,index)=>(
       <Stripe  val={elem}  />
    )
